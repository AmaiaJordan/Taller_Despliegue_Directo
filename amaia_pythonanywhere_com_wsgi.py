...
# web application at http://Amaia.pythonanywhere.com/
...
#import sys
#
#path = '/home/Amaia/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/Amaia/mysite/mysite/settings.py'
## and your manage.py is is at '/home/Amaia/mysite/manage.py'
#path = '/home/Amaia/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/Amaia" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/Amaia/myproject"
path = '/home/Amaia/Taller_Despliegue_Directo/'
if path not in sys.path:
    sys.path.append(path)
#
